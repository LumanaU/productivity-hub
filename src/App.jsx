...
export default function App({ authUser, profile, onLogout }) {
    ...
    try {
      ...
      if (data) {
        ...
        const analystMap = data.map(a => {
          ...
          return { ...a, enterpriseId: a.enterprise_id, fullName: a.full_name, active: a.active !== false, marks: marksByDate };
        });
  ...
  // Split analysts into active and inactive
  ...
  if(showAdminPanel && isAdminView) return (
    <div style={s.wrap}>
      ...
      <div style={s.section}>
                ...
                <div style={{display:"flex",alignItems:"center",gap:"10px",flex:1,minWidth:"180px"}}>
                  <div style={{position:"relative",width:36,height:36}}>
                    ...
                    <div style={{position:"absolute",bottom:-1,right:-1,width:12,height:12,borderRadius:"50%",
                      ...
                      boxShadow:online?"0 0 6px #10b98166":"none"}} title={online?"Online now":"Offline"} />
                  </div>
                  <div style={{flex:1,minWidth:0}}>
                    <div style={{display:"flex",alignItems:"center",gap:"6px"}}>
                    ...
                    {analyst.enterpriseId&&!analyst.email&&<div style={{fontSize:"11px",color:txt2}}>{analyst.enterpriseId}</div>}
                  </div>
                </div>
        ...
        <div style={{...s.card,background:dm?"#1a1a2e":"#eef2ff",border:`1.5px solid ${acc}33`}}>
          <div style={{fontSize:"13px",color:txt2,lineHeight:1.7}}>
            <strong style={{color:txt}}>📡 Live tracking:</strong> Analyst marks appear here in real time when they use the Enterprise Control on their device. New analysts are auto-created when they sign up. Use the "Manage Team" section above to deactivate/reactivate team members.
          </div>
        </div>
      </div>
      {BottomNav}
